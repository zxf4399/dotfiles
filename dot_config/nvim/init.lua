...
keyset("i", "<S-TAB>", [[coc#pum#visible() ? coc#pum#prev(1) : "\<C-h>"]], opts1)
...
keyset("n", "<space>a", ":<C-u>CocList diagnostics<cr>", opts4)
-- Manage extensions
keyset("n", "<space>e", ":<C-u>CocList extensions<cr>", opts4)
-- Show commands
keyset("n", "<space>c", ":<C-u>CocList commands<cr>", opts4)
-- Find symbol of current document
keyset("n", "<space>o", ":<C-u>CocList outline<cr>", opts4)
-- Search workspace symbols
keyset("n", "<space>s", ":<C-u>CocList -I symbols<cr>", opts4)
-- Do default action for next item
keyset("n", "<space>j", ":<C-u>CocNext<cr>", opts4)
-- Do default action for previous item
keyset("n", "<space>k", ":<C-u>CocPrev<cr>", opts4)
-- Resume latest coc list
keyset("n", "<space>p", ":<C-u>CocListResume<cr>", opts4)

keyset("n", "<space>e", "<Cmd>CocCommand explorer<CR>")
